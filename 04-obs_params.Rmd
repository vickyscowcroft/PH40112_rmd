...
--------------------------
In the section above we've said that the critial density is that for which the Universe is flat. But there's nothing in the Cosmological Principle that forces flatness. Quite the opposite in fact; $k$ is not restricted to be equal to zero.
...
We can substitute Eqs. \@ref(eq:fr-den-2) and \@ref(eq:big-omega) into the Friedman equation (Eq. \@ref(eq:fr-den-1)) to find a relationship between $\Omega$, $H$, and $k$. First we find
...
And remebering the equations for the critical density $\rho_c$ (Eq. \@ref(eq:fr-den-2) and the density parameter $\Omega$ (Eq. eq:big-omega), we find
...
We can treat $\Lambda$ as a fluid, similarly to the treatment we did for matter and radiation. Taking the Friedman equation (Eq. \@ref(eq:fr_lam)) and the density (Eq. \@ref(eq:den-lam-2)) we can show that 
...
and you will often see the parameter $w$ referred to as the **dark energy equation of state**. We will revist the evidence for $\Lambda$, and measurements of the other parameters discussed in this section soon.
