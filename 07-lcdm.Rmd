...
Table \@ref(tab:composition) summarises our current understanding of the Universe's composition. You are **not** expected to memorise the exact numbers in this table. However, it is useful for you to have a rough idea in your head of the proportions of the different consitutents.
